  ...
  return (
    <ScrollReveal direction="up" delay={index * 0.1} amount={0.1}>
      <motion.div
        ...
        className="glass-panel rounded-2xl overflow-hidden border-white/5 glass-card-hover group flex flex-col h-full"
      >
        ...
        <div className="relative h-52 overflow-hidden flex-shrink-0">
          ...
          <div className="absolute top-3 left-3 flex items-center gap-2">
            <span className={`text-[9px] font-bold tracking-widest uppercase px-2 py-0.5 glass-panel rounded-full border-white/10 ${accentColor}`}>
              {label}
            </span>
          ...
          <span className="absolute bottom-3 right-3 text-[10px] font-label text-white/40 glass-panel px-2 py-0.5 rounded-full border-white/8">
            {year}
          </span>
        </div>
        ...
        <div className="p-5 flex flex-col gap-3 flex-1">
          <h3 className={`text-base font-bold tracking-tight font-headline leading-tight group-hover:${accentColor} transition-colors text-white`}>
            {title}
          </h3>
          ...
          <div className="flex items-center gap-2 pt-2 border-t border-white/5">
            <Link
              ...
              className="flex-1 flex items-center justify-center gap-1.5 py-2 glass-panel rounded-xl border-white/10 hover:border-white/25 hover:bg-white/5 transition-all text-[11px] font-bold font-headline text-on-surface-variant hover:text-white group/btn"
            >
            ...
            <Link
              ...
              rel="noopener noreferrer"
              onClick={(e) => e.stopPropagation()}
              className={`flex-1 flex items-center justify-center gap-1.5 py-2 glass-panel rounded-xl border-white/10 hover:border-primary/30 hover:bg-primary/10 transition-all text-[11px] font-bold font-headline text-on-surface-variant hover:text-primary group/btn`}
            >
